...
class Details_subjects extends StatefulWidget {
  Item product;
  Details_subjects({required this.product});
      ...
      body: Container(
        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [Image.asset(widget.product.imgPath),
            //      CircleAvatar(
            //     radius: 150,
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(onPressed: (){
                      setState(() {
                        isGoin = !isGoin;
                        Carttt.add(items[Carttt.selectedSubject.length]);

                      });
                    }, child: Text(isGoin ? "Goin" : "Goined",style: TextStyle(fontSize: 20),))
                  ],
                ),
                const SizedBox(
                  height: 16,
